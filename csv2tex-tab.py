...
formatImpuls = "S[table-format=2.2] S[table-format=1.2] S[table-format=1.1] S[table-format=1.2] S[table-format=2.2] S[table-format=2.2]"
formatDurch = "S[table-format=2.2] S[table-format=2.1] S[table-format=1.1]"
formatAuge = "S[table-format=1.0] S[table-format=2.1]"

captionImpuls = "Daten der Durchschallung von verschiedenen Acrylzylindern mit der Impuls-Echo-Methode."
captionDurch = "Daten der Durchschallung von verschiedenen Acrylzylindern mit der Durchschallmethode."
captionAuge = "Zeitabstände der detektierten Pulse bei der Durchschallung eines Augenmodells mit der Impuls-Echo-Methode."

nameAuge = "auge"
nameDurch = "durchschall"
nameImpuls = "impuls-echo"

csv2textable("csv/" + nameAuge + ".csv", captionAuge, nameAuge, formatAuge)
csv2textable("csv/" + nameDurch + ".csv", captionDurch, nameDurch, formatDurch)
csv2textable("csv/" + nameImpuls + ".csv", captionImpuls, nameImpuls, formatImpuls)